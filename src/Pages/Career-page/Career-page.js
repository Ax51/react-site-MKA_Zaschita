    ...
    return (
        <div className="career-page">
            ...
            <div className="career-page_text">
                ...
                <ul>
                    <li className="ul_li"><a href="https://fparf.ru/documents/fpa-rf/the-documents-of-the-council/regulations-on-the-procedure-of-internship/" target="_blank" rel="noreferrer">Положение о порядке прохождения стажировки</a></li>
                    <li className="ul_li"><a href="https://fparf.ru/documents/fpa-rf/the-documents-of-the-council/regulations-on-the-procedure-of-work-of-the-assistant-to-the-lawyer/?sphrase_id=80015" target="_blank" rel="noreferrer">Положение о порядке работы помощника адвоката</a></li>
                </ul>
            </div>
        </div>
    )
