    ...
    return (
        <div className="about-page">
            ...
            <div className="about-page_block">
                ...
                <p className="about-page_block_why-us">Более подробно о том, для чего и кому нужен адвокат, Вы можете ознакомиться <a href="https://journal.tinkoff.ru/advocate/" target="_blank" rel="noreferrer">в статье по ссылке</a></p>
            </div>
            <div className="about-page_block">
